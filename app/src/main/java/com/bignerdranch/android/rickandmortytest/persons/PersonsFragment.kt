...
import com.bignerdranch.android.rickandmortytest.databinding.PersonItemListBinding
import com.bignerdranch.android.rickandmortytest.databinding.PersonRecyclerBinding
import com.bignerdranch.android.rickandmortytest.person.PersonFragment
    ...
    inner class PersonAdapter() :
        ...
        inner class PersonsHolder(view: View) : RecyclerView.ViewHolder(view),
            ...
            fun bind(data: Result) {
                binding.apply {
                    namePerson.text = getString(R.string.name, data.name)
